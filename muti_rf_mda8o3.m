...
for stationIndex2 = 129:129
    %生成机器学习需要的数组
%     stationIndex = r2Station(stationIndex2);
      stationIndex = stationIndex2;
try    
rawdata = [newDayArray(:,4,stationIndex) newDayArray(:,7,stationIndex) newDayArray(:,9,stationIndex) newDayArray(:,10,stationIndex) newDayArray(:,11,stationIndex) newDayArray(:,12,stationIndex) newDayArray(:,15,stationIndex)  newDayArray(:,16,stationIndex) trend];
